...
@export var seed = {
	Constants.VEGETABLE_TYPE.Beet: 0,
	Constants.VEGETABLE_TYPE.BlueFlower: 0,
	Constants.VEGETABLE_TYPE.Carrot: 0,
	Constants.VEGETABLE_TYPE.Cauliflower: 0,
	Constants.VEGETABLE_TYPE.Corn: 0,
	Constants.VEGETABLE_TYPE.Cucumber: 0,
	Constants.VEGETABLE_TYPE.Eggplant: 0,
	Constants.VEGETABLE_TYPE.Lettuce: 0,
	Constants.VEGETABLE_TYPE.Parsnip: 0,
	Constants.VEGETABLE_TYPE.Pumpkin: 0,
	Constants.VEGETABLE_TYPE.Rose: 0,
	Constants.VEGETABLE_TYPE.StarFruit: 0,
	Constants.VEGETABLE_TYPE.Tomato: 0,
	Constants.VEGETABLE_TYPE.Wheat: 0,
	####
